# Especificacao Tecnica — Fooddash Delivery

| Campo | Valor |
|---|---|
| Repositorio | `fooddash_delivery_project` |
...
Plataforma de delivery: pedidos, rotas e rastreamento. Este documento descreve requisitos, arquitetura e criterios de aceite.
