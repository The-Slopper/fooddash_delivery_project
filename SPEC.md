...
| Field | Value |
|---|---|
| Repository | `fooddash_delivery_project` |
...
Platform of delivery: orders, routes and tracking. This document describes requirements, architecture, and acceptance criteria.
